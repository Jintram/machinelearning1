...
# Go to the following path in "Files" beforehand:
# D:\Work\Udemy\Machine_Learning_Datasets\Part 1 - Data Preprocessing

# Or actually, let's do it here 
setwd("D:/Work/Udemy/Machine_Learning_Datasets/Part 1 - Data Preprocessing/")
...
dataset$Salary = ifelse(is.na(dataset$Salary), 
                        ave(dataset$Salary, FUN=function(x) 10),
                        dataset$Salary)
...
test_set[, 2:3]     = scale(test_set[, 2:3])
  # Note that columns 1 and 4 are categorical still.
